        ...
        <div class="w-full rounded-lg bg-slate-900 p-10 text-sm text-indigo-300 sm:w-96 max-w-96 mt-18">
            ...
            <form method="POST" action="{{route('admin.storeregister')}}">
                ...
                <div class="mb-5 flex gap-3 rounded-full bg-[#333A5c] px-6 py-3">
                    ...
                    <input type="text" placeholder="Full Name" name="name" class="border-none outline-none" required />
                </div>
                <div class="mb-5 flex gap-3 rounded-full bg-[#333A5c] px-6 py-3">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4">
                        <path
                    ...
                    <input type="email" placeholder="Email" name="email" class="border-none outline-none" required />
                </div>
                <div class="mb-5 flex gap-3 rounded-full bg-[#333A5c] px-6 py-3">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4">
                        <path
                    ...
                    <input type="password" placeholder="Password" name="password" class="border-none outline-none" required />
                </div>
                <button type="submit"
            ...
            <p class="mt-4 mb-7 text-center text-sm text-slate-400">Already Have an account? <a
                    href="{{route('admin.showlogin')}}" class="hover:underline text-blue-400"
